...
var CurrentText = React.createClass({
  render: function () {
    ...
    if (currentQuestText) {
      ...
      currentText =
        <div>
          <span className="active">Welcome! This web app can read WoW quest texts for you. </span>
          <span className="active">
            <span>If you haven't done so already, please install the </span>
            <a href="#">Quest Text Reader addon</a>
            <span>. </span>
          </span>
          <span className="active">This addon will generate links that tell this app what to read. </span>
          <span className="active">
