...
var CurrentText = React.createClass({
  render: function () {
    ...
    if (currentQuestText) {
      ...
      currentTitle = <h2 className='active'>Quest Text Reader</h2>;
      currentText =
        <div>
          <span className="active">This web app reads WoW quest texts to you. </span>
          ...
          <span className="active">This addon will generate personalized links that tell this app which quest texts to read. </span>
          <span className="active">
            <span>You can </span>
